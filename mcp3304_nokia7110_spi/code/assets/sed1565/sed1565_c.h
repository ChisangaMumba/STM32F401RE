...
void sed1565_setPosition(uint8_t page, uint8_t column)
{
	...
	// Nokia 7110 first column starts at 18 or 0x12
	sed1565_command(0x10 | ((column | 0x10) >> 4));		// High nibble	// (column | 0x10) only for Nokia 7110
	sed1565_command(0x00 | ((column | 0x02) & 0x0F));	// Low nibble		// (column | 0x02) only for Nokia 7110 
}
//------------------------------------------------------------------------------

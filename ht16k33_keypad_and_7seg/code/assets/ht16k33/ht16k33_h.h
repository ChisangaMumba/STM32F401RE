...
#define KEY_MEMORY			 0x40      //Start address. auto increments on every write. valid from 0x40 - 0x45 then auto wraps after last valid address
#define DECIMAL_POINT    0x80
//------------------------------------------------------------------------------
void    ht16k33_init(uint8_t brightness);
void    ht16k33_on(void);
void    ht16k33_blink(uint8_t data_t);
void    ht16k33_setBrightness(uint8_t data_t);

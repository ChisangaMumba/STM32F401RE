...
{   
	pcf8575_init(0x00, 0x00); // Initialize pcf8575 with all pins low (outputs)
...
void ks0108_command(uint8_t command, uint8_t chipNo)
{
  ...
  pcf8575_write(ctrlCommands, command);          
...
void ks0108_data(uint8_t data, uint8_t chipNo)
{
  ...
  pcf8575_write(ctrlCommands, data);          	
...
{
	pcf8575_write(ctrlData | EN_HIGH, data);
	pcf8575_write(ctrlData & EN_LOW, data);
}
//------------------------------------------------------------------------------

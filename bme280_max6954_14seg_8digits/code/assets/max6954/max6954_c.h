...
{     
  ...
  max6954_write(SHUTDOWN_REG, NORMAL_OPERATION, chip);
	max6954_write(DIGIT_TYPE_REG, MODE_14_SEG, chip);
}
//------------------------------------------------------------------------------
...
{
	uint8_t chip = chrPos / 8; // Determine which chip to write to based on character position. Max6954 is a 8 digit driver in 14 segment mode

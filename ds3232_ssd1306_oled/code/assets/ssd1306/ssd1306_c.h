...
//------------------------------------------------------------------------------
void ssd1306_print(uint8_t row, uint8_t col, const char* format, ...) 
{
	char str[40];
	...
	ssd1306_string(row, col, str);
}
//------------------------------------------------------------------------------
void ssd1306_string(uint8_t row, uint8_t col, char text[]) 
{
	ssd1306_setAddress(row, col);

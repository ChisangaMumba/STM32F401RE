...
#include "charset.h"
//--------------------------------------------------------------------------
#define CTRL_ADDR				0x40		// mcp23008 i/o expander for digit data
#define DATA_ADDR				0x42		// mcp23008 i/o expander for column select
//------------------------------------------------------------------------------
...
#define CTRL_ADDR				0x40		// mcp23s08 i/o expander for control signals
#define DATA_ADDR				0x42		// mcp23s08 i/o expander for data signals
//------------------------------------------------------------------------------

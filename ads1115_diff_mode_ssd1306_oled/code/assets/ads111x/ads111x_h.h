...
#define		ADS1115_ADDR_GND  			0x90	// Address Pin tied to ground
#define		ADS1115_ADDR_VDD  			0x92	// Address Pin tied to Vdd
#define		ADS1115_ADDR_SDA  			0x94	// Address Pin tied to SDA
#define		ADS1115_ADDR_SCL  			0x96	// Address Pin tied to SCL
#define		ADS1115_ADDR     				ADS1115_ADDR_GND	// 7-bit I2C sensor address (check your datasheet)
...
uint16_t	ads111x_read(uint8_t reg);
void			ads111x_write(uint8_t reg, uint16_t data);
void 			ads111x_config(uint16_t data);
float			ads111x_getVoltage(uint8_t mode, uint8_t chn);
//------------------------------------------------------------------------------
#endif
